...
## 第九次面试-2025-11月21日-哈啰两轮共享 30min
1. 实习做了哪些事
2. vue2和vue3的区别
3. 盒模型
4. 浏览器渲染页面过程
5. 健康南京app登陆注册功能怎么设计的
6. 简历中第一条-有遇到过很难的bug吗
7. FanUI组件库的亮点
8. FanUI组件库你认为做的过程中比较难的几点
...
12. 首屏加载慢的话你怎么解决
13. 反问
感觉这轮面试不是很重在考察技术，我问过面试官我这轮面试的表现情况，面试官说我对前沿技术的好奇心不太重，从我回答使用AI工具这方面看出来的。
